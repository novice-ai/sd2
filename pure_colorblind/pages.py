...
class Instructions(Page):
    ...
    def vars_for_template(self):
        ...
        if self.round_number == second_stage_start:
                ...
                instructions_text_2 = "本階段△求職者的受訓成本為 200 法幣 (c = 200)，◇求職者投的受訓成本為 600 法幣 (c = 600)。" 
                instructions_text_3 = "本階段雇主會看見配對到的求職者之類別。"
                ...
                instructions_text_2 = "本階段所有求職者的受訓成本為 200 法幣 (c = 200)。"
                instructions_text_3 = "本階段雇主不會看見配對到的求職者之類別。"
